...
export const dropdownStyles = tv({
  slots: {
    ...
    item: 'w-32 h-15 flex items-center justify-center shrink-0 transition-transform duration-200 hover:bg-gray-100 focus-visible:bg-gray-100 text-center cursor-pointer',
    icon: 'w-[10px] h-[6px] text-gray-500 ml-1 mt-[3px] shrink-0 transition-none cursor-pointer',
  },
  variants: {
    size: {
      md: {
