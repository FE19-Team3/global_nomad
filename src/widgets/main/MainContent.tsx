...
const MainContent = ({ initialData }: { initialData: ActivityListResponse }) => {
  ...
  return (
    <main className="bg-[linear-gradient(180deg,#f7dba2_-6.85%,#fffff7_22.43%,#FFFFFF_100%)] [[data-theme='dark']_&]:bg-[linear-gradient(180deg,#f7dba2_-6.85%,#444447_22.43%,#222222_100%)] overflow-x-hidden">
